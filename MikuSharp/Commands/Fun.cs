...
[SlashCommandGroup("fun", "Fun commands", false, [
...
internal class Fun : ApplicationCommandsModule
{
    ...
    public static async Task CoinflipAsync(InteractionContext ctx)
    {
        ...
        var flip = new[]
        {
            $"Heads {DiscordEmoji.FromName(ctx.Client, ":arrow_up_small:")}", $"Tails {DiscordEmoji.FromName(ctx.Client, ":arrow_down_small:")}"
        };
    ...
    public static async Task RpsAsync(InteractionContext ctx, [Option("rps", "Your rock paper scissor choice")] string rps)
    {
        ...
        var rock = new[]
        {
            $"Rock {DiscordEmoji.FromName(ctx.Client, ":black_circle:")}", $"Paper {DiscordEmoji.FromName(ctx.Client, ":pencil:")}", $"Scissors {DiscordEmoji.FromName(ctx.Client, ":scissors:")}"
        };
